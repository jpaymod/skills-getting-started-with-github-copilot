          ...
          .map(
            (email) => `
              <div class="participant-row">
                ...
                <button class="remove-participant" type="button" data-activity="${name}" data-email="${email}" aria-label="Remove ${email} from ${name}">✕</button>
              </div>
            `
          )
          .join("") || '<div class="participant-row empty">No participants yet</div>';
